...
def go_fewerPointsFitting(CIRC_NUMBER):
    ...
    #Important~~~ 
    #Please keep this
    list1 = [110, 190, 440, 940, 1540, 2140, 2220, 3000, 4000,5000, 6000,8000]
    ...
    img_save_dir=os.path.join(defaultPath, "saved_ims_v3_June_5_2024","WITH8000_TwelvePoints_Fit",CIRC_ID)
