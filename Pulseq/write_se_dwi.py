...
plot=True
write_seq=True
seq_filename = "se_pypulseq_dwi.seq"
...
for gDiff in [gDiff_50_x,gDiff_500_x]:
    ...
    for i in range(1,Ny+1):
        ...
        seq.add_block(pp.make_delay(delay_TE1),gDiff_50_x)
        seq.add_block(rf180,gz_spoil)
        seq.add_block(pp.make_delay(delay_TE2),gDiff_50_x)
        seq.add_block(gx, adc)  # Read one line of k-space
        #seq.add_block(gy)  # Phase blip
        gy_pre.area=((Ny / 2)-(i+1)) * delta_k
        #HardCode 8000ms
