...
dur = math.ceil(2 * math.sqrt(delta_ky / system.max_slew) / 10e-6) * 10e-6
...
#Put the pre x and pre y to after 90 and 180
delay_TE1 = math.ceil((
    TE / 2
...
% delayTE1 is our window for small_delta
...
seq_filename=f"se_dwi_pypulseq_Feb_8_2xspoiler_test.seq"

gDiff=gDiff_500_z


for ii in range(-Ny // 2, Ny // 2):  #-32 - +31 e.g.
    gy_pre = pp.make_trapezoid(
...
#%% for all b50 and b500
seq_filename=f"se_dwi_pypulseq_TE35_FOV432_172_160_64_b500_3dir_Jan21.seq"

for gDiff in [gDiff_500_x,gDiff_500_y,gDiff_500_z]:
